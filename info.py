...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001844256183').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('5098402375', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('https://t.me/zeeflixbackup')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Jacksparrow:jacksparrow@cluster0.fucg0qj.mongodb.net/?retryWrites=true&w=majority")
...
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', '-1001844256183'))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 'https://t.me/zeeflixbackup')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001744201813'))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', '-1001744201813'))
